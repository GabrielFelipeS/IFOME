		...
		<div class="main">
			<div class="form-group">
				...
				<div class="md:columns-2 w-full">
					...
					<div class="w-full">
						...
						<input type="text" placeholder="Selecione uma categoria" class="form-input"
							   required id="category">
					</div>
				</div>
				<p class="text-center w-full mb-1 mt-3 font-semibold">Foto do prato</p>
				<div class="border-2 border-dashed border-gray-300 rounded-lg p-5 w-full text-center h-[20%] flex items-center justify-center"
					 @dragover.prevent="dragOver" @dragleave.prevent="dragLeave" @drop.prevent="drop" id="drag-drop-photo">
			...
			<div class="btn-container">
				<button type="button" class="button text-primary hover:text-white border border-primary
					...
					<v-icon name="fa-times" /> Cancelar</button>
				...
				Salvar prato <v-icon name="fa-save" /></button>
			</div>
		</div>
	</Modal>
</template>
