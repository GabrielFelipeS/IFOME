...
@Operation(
    summary = "Pegar pratos com paginação",
    parameters = {
        ...
        @Parameter(name = "sort", description = "Critério de ordenação, no formato 'propriedade,direção' (por exemplo, 'name,asc' ou 'name,desc')", required = false, schema = @Schema(type = "string", defaultValue = "name,asc"))
    },
